  ...
  return (
    <section className="ml-14 mt-16  md:ml-56 h-full overflow-y-auto">
      ...
      <div className="flex my-4">
        <button className="border rounded-lg bg-buttonColor text-white px-2 py-1 mr-3" onClick={()=>navigate('/items/itemname')}>
          Save
        </button>
        <button className="border rounded-lg px-2 py-1" onClick={()=>navigate('/items/itemname')}>Cancel</button>
      </div>
    </section>
  );
}
